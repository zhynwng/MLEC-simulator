...
commands=(
    "python main.py -afr=1 -k_local=2 -p_local=1 -total_drives=57600 -drives_per_rack=960 -io_speed=40 -placement=SLEC_LOCAL_CP -concur=256 -iter=10000 -sim_mode=1 -repair_scheme=0 -interrack_speed=2 -detection_time=30 -num_local_fail_to_report=2" 
)
...
echo "SLEC_LOCAL_CP 2+1 durability: $total_nines"
...
echo "SLEC_LOCAL_CP 2+1 throughput: $throughput_result"
...
echo "SLEC_LOCAL_CP 2+1 $total_nines $throughput_result" >> $result_dir/slec-local-cp-dur-thru.dat