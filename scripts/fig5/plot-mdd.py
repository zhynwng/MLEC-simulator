...
if placement == 'D/C':
    axes.add_patch(patches.Rectangle((0.5, 48.5), 48, 2, linewidth=linewidth, edgecolor=anotation_color, facecolor='none'))
...
if placement == 'D/D':
    plt.text(14, 3, 'F#4', annotation_font, color=anotation_color)
    plt.arrow(21.5,12,-18,46,head_width=1, head_length=2, linewidth=linewidth, color=anotation_color,length_includes_head=True, joinstyle='miter')
    plt.text(35, 22, 'F#7', annotation_font, color=anotation_color)
